...
func (a *APIsApiService) ForecastWeather(ctx context.Context, q string, days int32, localVarOptionals *APIsApiForecastWeatherOpts) (ForecastResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
